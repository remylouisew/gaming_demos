...
#   Usage:
'''
python fps_logs_dataflow.py \
    --gcp_project gaming-demos \
    --region us-central1 \
    --job_name 'fpsgamelogs' \
    --gcp_staging_location "gs://gaming-dataflow/staging" \
    --gcp_tmp_location "gs://gaming-dataflow/tmp" \
    --batch_size 10 \
    --input_topic projects/gaming-demos/topics/fps_game_logs \
    --bq_dataset_name games \
    --bq_table_name fps_game_logs \
    --runner DirectRunner
...
def run(argv=None):
    ...
    with beam.Pipeline(options=pipeline_options) as p:
        ...
        # Tranform events
        transformed = (
            parsed  | beam.Map(extract_weapon_type)
